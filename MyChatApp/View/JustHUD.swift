...
class JustHUD: UIView {
    ...
    class func setHeaderColor(color: UIColor) {
        instance.headerColor = color
    }
    
    class func setFooterColor(color: UIColor) {
        instance.footerColor = color
    }
    
    class func setLoaderColor(color: UIColor) {
        instance.loaderColor = color
    }
    
    class func setBackgroundColor(color: UIColor, automaticTextColor: Bool = false) {
        instance.backColor = color
        if automaticTextColor {
            instance.headerColor = getComplementaryForColor(color: color, relativeTo: instance.headerColor)
            instance.footerColor = getComplementaryForColor(color: color, relativeTo: instance.footerColor)
            instance.loaderColor = getComplementaryForColor(color: color, relativeTo: instance.loaderColor)
        }
    }
